        ...
        <div>
            ...
            <div className="lg:hidden md:block block">
                <div className="absolute bottom-0 left-0">
                    <div onClick={() => setIsMenuOpen(!isMenuOpen)} class={`fixed z-40 w-full overflow-y-auto bg-white border-t border-gray-200 rounded-t-lg dark:border-gray-700 dark:bg-gray-800 left-0 right-0 transition-all translate-y-full ${isMenuOpen ? 'bottom-[330px]' : 'bottom-[60px]'} `}>
